...
namespace App
{
    public class MockDao : IDao
    {
        ...
        public MockDao()
        {
            ...
            _products = new()
            {
                new() { Id = 1, Name = "Latte", Price = 45000, Size = "M", Image = "/Assets/latte.jpg", TypeBeverageId = 1 },
                new() { Id = 2, Name = "Green Tea", Price = 35000, Size = "L", Image = "/Assets/green_tea.jpg", TypeBeverageId = 2 },
                new() { Id = 3, Name = "Milk Tea", Price = 30000, Size = "L", Image = "/Assets/milk_tea.jpg", TypeBeverageId = 2 },
                new() { Id = 4, Name = "Orange Juice", Price = 25000, Size = "S", Image = "/Assets/orange_juice.jpg", TypeBeverageId = 3 },
                new() { Id = 5, Name = "Espresso", Price = 40000, Size = "S", Image = "/Assets/espresso.jpg", TypeBeverageId = 1 },
                new() { Id = 6, Name = "Black Coffee", Price = 30000, Size = "M", Image = "/Assets/black_coffee.jpg", TypeBeverageId = 1 },
                new() { Id = 7, Name = "Oolong Tea", Price = 35000, Size = "L", Image = "/Assets/oolong_tea.jpg", TypeBeverageId = 2 },
                new() { Id = 8, Name = "Apple Juice", Price = 27000, Size = "S", Image = "/Assets/apple_juice.jpg", TypeBeverageId = 3 },
                new() { Id = 9, Name = "Smoothie", Price = 45000, Size = "M", Image = "/Assets/smoothie.jpg", TypeBeverageId = 4 },
                new() { Id = 10, Name = "Iced Latte", Price = 50000, Size = "L", Image = "/Assets/iced_latte.jpg", TypeBeverageId = 1 },
                new() { Id = 11, Name = "Matcha Latte", Price = 48000, Size = "M", Image = "/Assets/matcha_latte.jpg", TypeBeverageId = 2 },
                new() { Id = 12, Name = "Lemon Tea", Price = 32000, Size = "L", Image = "/Assets/lemon_tea.jpg", TypeBeverageId = 2 },
                new() { Id = 13, Name = "Pineapple Juice", Price = 29000, Size = "S", Image = "/Assets/pineapple_juice.jpg", TypeBeverageId = 3 },
                new() { Id = 14, Name = "Mango Smoothie", Price = 47000, Size = "M", Image = "/Assets/mango_smoothie.jpg", TypeBeverageId = 4 },
                new() { Id = 15, Name = "Cappuccino", Price = 42000, Size = "S", Image = "/Assets/cappuccino.jpg", TypeBeverageId = 1 }
            };
