#pragma checksum "C:\Users\lenovo\source\repos\App\App\Views\ListDetailsPage.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "7772AF77B325CD30EC8A84EF267D2AC8BDA178B142BB179B1137169ED885447F"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace App.Views
{
        ...
        global::Microsoft.UI.Xaml.Markup.IComponentConnector
    {
        ...
        private class ListDetailsPage_obj1_Bindings :
            ...
            IListDetailsPage_Bindings
        {
            private global::App.Views.ListDetailsPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                ...
                if (newDataRoot != null)
                {
                    this.dataRoot = global::WinRT.CastExtensions.As<global::App.Views.ListDetailsPage>(newDataRoot);
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::App.Views.ListDetailsPage obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_ViewModel(global::App.ViewModels.ListDetailsViewModel obj, int phase)
            {
            ...
            private void Update_ViewModel_SampleItems(global::System.Collections.ObjectModel.ObservableCollection<global::App.Core.Models.SampleOrder> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_ViewModel_Selected(global::App.Core.Models.SampleOrder obj, int phase)
            {
            ...
            private void UpdateTwoWay_12_SelectedItem()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        ...
                        {
                            this.dataRoot.ViewModel.Selected = (global::App.Core.Models.SampleOrder)this.obj12.SelectedItem;
                        }
                    }
                }
            }
            ...
            private class ListDetailsPage_obj1_BindingsTracking
            {
                ...
                public void PropertyChanged_ViewModel(object sender, global::System.ComponentModel.PropertyChangedEventArgs e)
                {
                    ...
                    if (bindings != null)
                    {
                        ...
                        global::App.ViewModels.ListDetailsViewModel obj = sender as global::App.ViewModels.ListDetailsViewModel;
                ...
                private global::App.ViewModels.ListDetailsViewModel cache_ViewModel = null;
                public void UpdateChildListeners_ViewModel(global::App.ViewModels.ListDetailsViewModel obj)
                {
