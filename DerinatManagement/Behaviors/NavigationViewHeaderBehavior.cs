...
namespace DerinatManagement.Behaviors;
...
public class NavigationViewHeaderBehavior : Behavior<NavigationView>
{
    ...
    public static readonly DependencyProperty HeaderModeProperty =
     DependencyProperty.RegisterAttached("HeaderMode", typeof(NavigationViewHeaderMode), typeof(NavigationViewHeaderBehavior), new PropertyMetadata(NavigationViewHeaderMode.Never, (d, e) => _current!.UpdateHeader()));
